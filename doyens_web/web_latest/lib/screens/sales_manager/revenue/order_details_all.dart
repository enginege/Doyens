...
class OrderDetailsAllPage3 extends StatefulWidget {
  final TransactionClass transaction;

  // In the constructor, require a Person
  OrderDetailsAllPage3({Key? key, required this.transaction}) : super(key: key);
  @override
  _OrderDetailsPageState createState() => _OrderDetailsPageState();
}

class _OrderDetailsPageState extends State<OrderDetailsAllPage3> {
  @override
