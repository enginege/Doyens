...
class Body extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      padding:
          EdgeInsets.symmetric(horizontal: getProportionateScreenWidth(47)),
      child: Container(
        decoration: BoxDecoration(
                          ...
                          child: Padding(
                              ...
                              child: Column(children: [
                                Padding(
                                  ...
                                  child: Text("Stock count: "+ product.stock.toString()),
                                ),
                                Padding(
                                  padding: const EdgeInsets.all(8.0),
                                  child: DefaultButton(
                                    ...
                                    press: () async {
                                      ...
                                      if (product.stock == 0) {
                                        ...
                                        for (int i = 0;
                                            ...
                                            i++) {
                                          if (currentCart.cartItems![i].product
                                                  .title ==
                                              product.title) {
                                            if (currentCart.cartItems![i]
                                                        .numOfItem +
                                                    numOfItemToAdd >
                                                product.stock) {
                                              if (product.stock -
                                                      currentCart.cartItems![i]
                                                          .numOfItem <
                                                  1) {
                                                problem = true;
                                                ScaffoldMessenger.of(context)
