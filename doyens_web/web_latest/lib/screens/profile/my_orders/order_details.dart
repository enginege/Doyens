...
class _OrderDetailsPageState extends State<OrderDetailsPage> {
  ...
  Widget _listOrder(TransactionClass model) {
    var purchaseDate = model.purchaseDate.toDate();
    var tempDate = new DateTime(
        purchaseDate.year, purchaseDate.month, purchaseDate.day + 30);
    bool isRefundable = false;
    if (DateTime.now().isBefore(tempDate)) {
      isRefundable = true;
    }
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        ...
        //Add ListTiles that are "enabled: false" for the refunded items.
        return ListTile(
          dense: false,
                ...
                child: SizedBox(
                  ...
                  child: ElevatedButton(
                    ...
                    child: Text(
                      "Review",
                      style: TextStyle(
                        fontSize: 10,//getProportionateScreenWidth(12),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () async {
                    ...
                    if (await checkifRefundApproved(
                            currentitem, model.transactionid) ==
                        true) {
                      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                        content: Text(
                          "Your refund has been completed for this item!",
                          textAlign: TextAlign.center,
                          style: TextStyle(
                              fontSize: 16.0, fontWeight: FontWeight.bold),
                        ),
                    ...
                    } else if (await checkifRefundExists(
                            currentitem, model.transactionid) ==
                        true) {
                      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                        content: Text(
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(SnackBar(
                        content: Text(
                          "You cannot request a refund for a supplement that you bought more than 30 days before",
                          textAlign: TextAlign.center,
                          style: TextStyle(
                              fontSize: 16.0, fontWeight: FontWeight.bold),
                        ),
