...
class AllTransactionsScreen3 extends StatefulWidget {
  @override
  State<AllTransactionsScreen3> createState() => _AllTransactionsScreenState();
}

class _AllTransactionsScreenState extends State<AllTransactionsScreen3> {
      ...
      builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
        ...
        snapshot.data!.docs.map((DocumentSnapshot document) {
          ...
          if (startDate.isBefore(newtrans.purchaseDate.toDate()) &&
            ...
            totalRevenue = totalRevenue + newtrans.totalprice.toInt();
        ...
        /*for(var key in transactions){
          if (startDate.isBefore(newtrans.purchaseDate.toDate()) &&
              endDate.isAfter(newtrans.purchaseDate.toDate()) && newtrans.orderstatus == "completed"){
                totalRevenue += key.totalprice.toDouble();
              }
        }*/
        return Scaffold(
            appBar: AppBar(
            ...
            body: ListView(
              children: [
                Text("Total Revenue: $totalRevenue"+"\$", style: TextStyle(fontSize: 20,
                fontWeight: FontWeight.bold),
                
                 ),
                 Text("Number of transaction: "+transactions.length.toString()),
                ListView.builder(
                              ...
                              flatButton(
                                ...
                                () {
                                  Navigator.of(context).push(MaterialPageRoute(
                                      builder: (context) => OrderDetailsAllPage3(
