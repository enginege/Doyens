...
import '../../../models/Transaction2.dart';
import '../../../size_config.dart';

class OrderDetailsAllPage2 extends StatefulWidget {
  final TransactionClass transaction;

  // In the constructor, require a Person
  OrderDetailsAllPage2({Key? key, required this.transaction}) : super(key: key);
  @override
  _OrderDetailsPageState createState() => _OrderDetailsPageState();
}

class _OrderDetailsPageState extends State<OrderDetailsAllPage2> {
  @override
